...
if __name__ == "__main__":
    ...
    feat_train_file = '../features/title.boc.3grams.trn'
    feat_test_file = '../features/title.boc.3grams.tst'
    extract_title_text_features(train_file, test_file, feat_train_file, feat_test_file, analyzer='char', ngram_range=(1, 3))
    
    feat_train_file = '../features/title.boc.4grams.trn'
    feat_test_file = '../features/title.boc.4grams.tst'
    extract_title_text_features(train_file, test_file, feat_train_file, feat_test_file, analyzer='char', ngram_range=(1, 4))
