...
if __name__ == '__main__':
    ...
    df_tr.to_csv('../features/conciseness.L1_FoldSet%d_xx.TRAINSET.csv' % fold_set, index=False)        
    df_va.to_csv('../features/conciseness.L1_FoldSet%d_xx.TESTSET.full.csv' % fold_set, index=False)        
    for k in range(10):
        df_te = df_te_set[k]
        df_va.to_csv('../features/conciseness.L1_FoldSet%d_xx.TESTSET.fold%d.csv' % (fold_set, k), index=False) 
